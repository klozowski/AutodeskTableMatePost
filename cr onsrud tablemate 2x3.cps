...
longDescription = "CR Onsrud Tablemate 2x3 3-axis Router with B&R Control";
...
allowedCircularPlanes = 1; // allow any circular motion 1 =G17 was undefined
...
function onOpen() {
  ...
  sequenceNumber = properties.sequenceNumberStart;
	...
	writeBlock("(Filename: )"); // insert filename here
	writeBlock("(Machine:  CR Onsrud Tablemate 2x3)")
	 

  // absolute coordinates and feed per min
  writeBlock(gMotionModal.format(0), gPlaneModal.format(17), gFormat.format(40), gAbsIncModal.format(90));
...
//    writeBlock(gMotionModal.format(0), "Z" + xyzFormat.format(0)); // retract
...
/* 	writeBlock("M03");
	speedtext=sOutput.format(tool.spindleRPM)
	writeComment (speedtext);
	onDwell(4);
 */
